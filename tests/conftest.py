...
# WARNING: Ensure imports from `fastapi_full_template` comes after this line
from fastapi_full_template import app, settings, db  # noqa
from fastapi_full_template.cli import create_user, cli  # noqa
